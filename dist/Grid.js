...
var stepsBetweenVerticalLines=this.props.horizontalGridStep?Math.round(data.length/this.props.horizontalGridStep):1;
if(stepsBetweenVerticalLines<1)stepsBetweenVerticalLines=1;

for(var i=horizontalSteps;i>0;i--){horizontalRange.push(i);}
for(var _i=data.length-1;_i>0;_i-=stepsBetweenVerticalLines){verticalRange.push(_i);}
...
return(
_react2.default.createElement(_reactNative.View,{style:{position:'absolute',flexDirection:'column',justifyContent:'space-around'}},
horizontalRange.map(function(_,i){return _react2.default.createElement(_reactNative.View,{key:i,style:horizontalGridStyle});})));
...
return(
_react2.default.createElement(_reactNative.View,{style:{flexDirection:'row',position:'absolute',justifyContent:'space-around'}},
verticalRange.map(function(_,i){return _react2.default.createElement(_reactNative.View,{key:i,style:verticalGridStyle});})));
